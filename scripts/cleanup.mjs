...
const targetClient = createClient({
  projectId: 'ie4h9yk3', // Your Sanity project ID
  dataset: "production", // Default to "production" if not set
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: "2023-01-01", // Sanity API version
  token: 'sk9YHNBufBhKqOBCo9QX2tt7lAE9LDCdBsbdc1EdHXvHnQ1Z1YCsWwy666QnRugAaglGtJMowTzkdKL7laUUgCjZGNqE9uhSGGrY8dvTE6j7WuGXVxesB4ogke09JOkg3LWYfseqEvYVARXEGaHxDx2NoyM5VTJ9CuqASkIhpKpxSOjCM9ld', // API token for authentication
});
