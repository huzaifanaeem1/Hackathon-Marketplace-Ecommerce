...
// const AboutHero = () => {
//   return (
//     <><div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center bg-white mt-24 pt-60 md:mt-32 px-4">
//           {/* Left Section */}
...
//           </div>
//       </div><div className="max-w-screen-xl mx-auto mt-32 px-6">
...
//                   <TbTruckDelivery className="w-[24px] h-[24px] text-[#007580]  ml-4" />
...
//                   <div className="bg-[#F9F9F9] p-6 text-center">
//                   <FaRegCheckCircle className="w-[24px] h-[24px] text-[#007580] ml-3" />
//                       <h3 className="text-[20px] font-normal text-[#007580] flex items-center justify-center pt-5">
...
//                   <div className="bg-[#F9F9F9] p-6 text-center">
//                   <GoCreditCard className="w-[24px] h-[24px] text-[#007580] ml-8" />
//                       <h3 className="text-[20px] font-normal text-[#007580] flex items-center justify-center pt-5">
...
//                   <div className="bg-[#F9F9F9] p-6 text-center">
//                   <LuSprout className="w-[24px] h-[24px] text-[#007580]  ml-4" />
//                       <h3 className="text-[20px] font-normal text-[#007580] flex items-center justify-center pt-5">
...
//           />
//           <p className="text-[#2A254B] pt-5 text-[20px] font-normal text-left ">The Poplar Suede Sofa</p>
//           <p className="text-[#2A254B] pt-2 text-[18px] font-normal mb-32 text-left ">$99.00</p>
//         </div>
//         <div className="text-center">
//           <Image
//             src="/images/Product/about2.jpg"
//             alt="img2"
//             width={305}
//             height={465}
//             className="object-cover mx-auto"
//           />
//           <p className="text-[#2A254B] pt-5 text-[20px] font-normal text-left ">The Dandy Chair</p>
//           <p className="text-[#2A254B] pt-2 text-[18px] font-normal mb-32 text-left ">$99.00</p>
//         </div>
//         <div className="text-center">
//           <Image
//             src="/images/Product/about3.jpg"
//             alt="img3"
//             width={305}
//             height={465}
//             className="object-cover mx-auto"
...
import PopularProduct from '@/components/about/PopularProduct'
